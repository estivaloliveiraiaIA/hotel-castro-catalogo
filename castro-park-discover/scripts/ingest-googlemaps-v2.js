...
const SEARCH_QUERIES = [
  // Restaurantes
  { query: "restaurantes Goiânia", category: "restaurants", maxResults: 400 },
  { query: "churrascarias Goiânia", category: "restaurants", maxResults: 150 },
  { query: "pizzarias Goiânia", category: "restaurants", maxResults: 100 },
  { query: "sushi Goiânia", category: "restaurants", maxResults: 80 },

  // Cafés
  { query: "cafeterias Goiânia", category: "cafes", maxResults: 100 },
  { query: "cafés Goiânia", category: "cafes", maxResults: 100 },

  // Bares
  { query: "bares Goiânia", category: "nightlife", maxResults: 150 },
  { query: "pubs Goiânia", category: "nightlife", maxResults: 80 },

  // Natureza
  { query: "parques Goiânia", category: "nature", maxResults: 80 },
  { query: "praças Goiânia", category: "nature", maxResults: 80 },

  // Cultura
  { query: "museus Goiânia", category: "culture", maxResults: 40 },
  { query: "teatros Goiânia", category: "culture", maxResults: 30 },

  // Shopping
  { query: "shoppings Goiânia", category: "shopping", maxResults: 40 },
  { query: "lojas Goiânia", category: "shopping", maxResults: 100 },

  // Atrações
  { query: "pontos turísticos Goiânia", category: "attractions", maxResults: 100 },
  { query: "atrações Goiânia", category: "attractions", maxResults: 100 },
];
...
const ACTOR_ID = "nwua9Gu5YrADL7ZDj";  // Google Maps Scraper FREE
  ...
  for (const searchQuery of SEARCH_QUERIES) {
    ...
    try {
      const input = {
        ...
        maxImagesPerPlace: 5,
        maxCrawledPlaces: searchQuery.maxResults,
        language: "pt-BR",
...
function normalizePlace(item, originQuery, category) {
  ...
  if (item.images && Array.isArray(item.images)) {
    gallery.push(...item.images.map(img => img.url || img).filter(Boolean).slice(0, 5));
  }
